...
public class SistemaGestionPrestamos {
    ...
    public void generarReporteUsoPorGrupo(){
        ...
        String ultimoGrupo = "";  // Mantiene el control del último grupo procesado.

    for (Instrumento instrumento : listaInstrumentos) {
    // Si el grupo del instrumento actual es diferente del último procesado, lo agregamos al reporte.
    if (!instrumento.getGrupo().equals(ultimoGrupo)) {
        reporte.append("\nGrupo: ").append(instrumento.getGrupo()).append("\n");
        ultimoGrupo = instrumento.getGrupo();  // Actualizamos el último grupo procesado.
    }

    // Añadimos el nombre y cantidad del instrumento al reporte.
    reporte.append("Nombre: ").append(instrumento.getNombre()).append("\n");
    reporte.append("Cantidad disponible: ").append(instrumento.getCantidadDisponible()).append("\n");
    }
